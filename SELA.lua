...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/fares355/Files-boyka/master/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1151371484,1317966118,1424388256}   
...
var = true 
elseif tonumber(user_id) == tonumber(1456178972) then
var = true  
...
--------------------------------------------------------------------------------------------------------------
function SourceSELA(msg,data) -- بداية العمل
if msg then
...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ↯ [تحديثات البوت](t.me/sourcesela) \n ↯ [قناه السورس](t.me/sourcesela)')
end
if text == 'المبرمج فارس' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ↯ [المبرمج فارس](t.me/IE_S9) \n ↯ [المبرمج فارس](t.me/IE_S9)')
end
...
t = "\n ↯ قائمة المطورين \nــــ↯ـــــــــᵴỖǕᏒḈE ᵴḔⱠẦ ــــــــ↯ــــــــ\n"
for k,v in pairs(list) do
...
usertext = '\n ↯ العضو » ['..result.title_..'](t.me/'..(username or 'sourcesela')..')'
status  = '\n ↯ تم ترقيته مطور'
...
usertext = '\n ↯ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'sourcesela')..')'
status  = '\n ↯ تم ترقيته مطور'
...
if SELA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ↯ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'sourcesela')..') \n ↯ '..SELA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ↯ العضو : {["..data.first_name_.."](T.ME/sourcesela)}\n ↯ ["..SELA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ↯ عذرا » {["..data.first_name_.."](T.ME/sourcesela)}\n ↯ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
↯♡  ━━━  ᵴᵉᴌẤ  ━━━ ↯♡
 ...
 [- The SOURCE channel](https://t.me/sourcesela) ☆ .
↯♡  ━━━  ᵴᵉᴌẤ  ━━━ ↯♡
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ↯ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'sourcesela')..') \n ↯ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ↯ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'sourcesela')..') \n ↯ تـم قفـل التاك بالكتم ')
end,nil)   
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/fares355/Files_Boyka/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ↯ اهلا بك في متجر ملفات سيلا\n ↯ ملفات السورس ↓\nــــ↯ـــــــــᵴỖǕᏒḈE ᵴḔⱠẦ ــــــــ↯ــــــــ\n\n"
local TextE = "\nــــ↯ـــــــــᵴỖǕᏒḈE ᵴḔⱠẦ ــــــــ↯ــــــــ\n ↯ علامة تعني { ✓ } ملف مفعل\n ↯ علامة تعني { ✘ } ملف معطل\n ↯ قناة سورس سيلا ↓\n".." ↯ [اضغط هنا لدخول](t.me/sourcesela) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/fares355/Files_Boyka/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('SELA.lua')  
else
send(msg.chat_id_, msg.id_," ↯ عذرا الملف لايدعم سورس سيلا \n") 
end
return false
end
...
local UserName = (b.username_ or "sourcesela")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ↯ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'sourcesela')..')'
status  = '\n ↯ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ↯ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext =  \n ☆↯⇠ العضــو » [ ..data.first_name_.. ](t.me/ ..(data.username_ or  sourcesela ).. ) 
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ↯ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'sourcesela')..')'..'\n ↯ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'سيلا').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'سيلا')
local SELA_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'سيلا').." غادر" or text == 'غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'sourcesela')..')'
local iduser = result.sender_user_id_
...
ٴــــ↯ـــــــــᵴỖǕᏒḈE ᵴḔⱠẦ ــــــــ↯ــــــــٴ
*↯♡↯م1 ◂ اوامر الحمايه*
...
*↯♡↯م10 ◂ اوامر الاعضاء*
ٴــــ↯ـــــــــᵴỖǕᏒḈE ᵴḔⱠẦ ــــــــ↯ــــــــٴ
彡 .[ᵴỖǕᏒḈE ᵴḔⱠẦ 𖤐](t.me/sourcesela)➢ 
]]
...
zx = JSON.decode(zh)
t = "\n↯ قائمه الزخرفه \nٴ↯ٴــــ↯ـــــــــᵴỖǕᏒḈE ᵴḔⱠẦ ــــــــ↯ــــــــٴ↯○ٴ \n"
i = 0
for k,v in pairs(zx.ok) do
i = i + 1
t = t..i.."-  "..v.." \n"
end
send(msg.chat_id_, msg.id_, t..'ٴ↯ٴــــ↯ـــــــــᵴỖǕᏒḈE ᵴḔⱠẦ ــــــــ↯ــــــــٴ↯○ٴ\n↯ 彡 .[ᵴỖǕᏒḈE ᵴḔⱠẦ 𖤐](t.me/sourcesela)➢ ')
end
...
ٴــــ↯ـــــــــᵴỖǕᏒḈE ᵴḔⱠẦ ــــــــ↯ــــــــ
...
flash = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(flash)
...
--------------------------------------------------------------------------------------------------------------
Sourceflash(data.message_,data)
plugin_adham(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
